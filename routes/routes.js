...
const { addPagamento, deletePagamento, updatePagamento, listaPagamentos } = require('../controllers/pagamentoControler');
...
router.post('/produtos/venda/pagamentos', listaPagamentos);
